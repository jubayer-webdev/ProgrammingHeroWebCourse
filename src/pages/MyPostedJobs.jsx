                                ...
                                <tbody className="bg-white divide-y divide-gray-200 ">
                                    ...
                                    {jobs.map((job) => (
                                        <tr key={job._id}>
                                            ...
                                            <td className="px-4 py-4 text-sm text-gray-500  whitespace-nowrap">{new Date(job.deadline).toLocaleDateString()}</td>
                                            ...
                                            <td className="px-4 py-4 text-sm whitespace-nowrap">
                                                <div className="flex items-center gap-x-2">
                                                    <p className={`px-3 py-1 ${job.category === "Web Development" && "text-blue-500 bg-blue-100/60"} ${job.category === "Graphics Design" && "text-emerald-500 bg-emerald-100/60"} ${job.category === "Digital Marketing" && "text-pink-500 bg-pink-100/60"} text-xs  rounded-full`}>{job.category}</p>
                                                </div>
                                            </td>
